...
import 'package:organico_app/constants/color_const.dart';
import 'package:organico_app/constants/fonts_const.dart';
import 'package:organico_app/constants/sizeconfig.dart';
import 'package:organico_app/provider/bottomnav_provider.dart';
      ...
      builder: (BuildContext context, Widget? child) {
        return Scaffold(
          ...
          bottomNavigationBar: Container(
            ...
            height: SizeConfig.height(74),
            decoration: BoxDecoration(
              borderRadius: BorderRadius.vertical(
                top: Radius.circular(SizeConfig.width(20)),
              ),
              boxShadow: <BoxShadow>[
                BoxShadow(
